...
class EnemyService {
     ...
     */
    create(enemyType, level = 1, extraConfig = {}) {  
        ...
        // Дополнительные поля из комнаты
        if (extraConfig.gridX !== undefined) enemy.gridX = extraConfig.gridX;
        if (extraConfig.gridY !== undefined) enemy.gridY = extraConfig.gridY;
